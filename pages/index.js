  ...
  return (
    <div className="relative min-h-screen bg-black text-white font-sans overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6 text-center">
        ...
        <p className="text-xl mb-12 uppercase tracking-widest text-yellow-400">Industrial Strength Optimization</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 w-full max-w-4xl">
          ...
          <div className="border border-zinc-800 bg-black/50 p-10 rounded-3xl opacity-50">
            ...
            <button className="w-full bg-zinc-700 text-white font-black py-4 rounded-xl mt-4 cursor-not-allowed">LOCKED</button>
          </div>
        </div>
      </main>
    </div>
